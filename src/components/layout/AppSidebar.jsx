...
export default function AppSidebar() {
  ...
  const NavButton = ({
    ...
    >
      ...
      {!collapsed && (
        <span className="text-[13px] flex-1 text-left font-semibold">
          {label}
        </span>
      )}
        ...
        <div className="px-3 pt-5 pb-3">
          {collapsed ? (
            ...
            <div className="flex items-center gap-3 px-1">
              ...
              >
                <div
                  className="text-sidebar-foreground text-[17px] font-bold tracking-[0.12em] leading-none"
                  style={{
                    fontFamily:
                ...
                <div className="text-sidebar-foreground/55 text-[9px] font-medium tracking-[0.025em] mt-1.5 whitespace-nowrap">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-1.5 px-2 pb-1 mb-0.5 border-b border-sidebar-border/40">
                      <Folder
                        size={11}
                        className="text-sidebar-foreground/80 shrink-0"
                      />
