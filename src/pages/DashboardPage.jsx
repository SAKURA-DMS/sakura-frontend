...
export default function DashboardPage() {
  ...
  const handleChartDateClick = (date, status) => {
    ...
    const label = status
      ? `Dokumen ${status} tanggal ${date}`
      : `Dokumen tanggal ${date}`;
  ...
  const handleStatusClick = (status) => {
    if (status === "all") {
      ...
      setListModal({
        ...
        docs: visibleDocs.filter((d) => d.status === status),
      });
    }
  };
  ...
  return (
    <>
      <AppHeader
        title="Dashboard"
        subtitle="Ringkasan aktivitas dokumen"
      />
      ...
      <div className="p-6 lg:p-8 space-y-6 bg-background">
        ...
        <div
          className="
            ...
            via-card
            to-primary/[0.07]
            shadow-[0_10px_30px_rgba(70,30,45,0.045)]
          "
        >
          {/* Soft pink atmosphere di sisi kanan */}
          <div
            className="
              absolute
              inset-y-0
          ...
          >
            ...
            {/* Fade dari gambar ke area tulisan */}
            <div
              className="
                absolute
                inset-0
          ...
          >
            ...
            <p
              ...
              "
            >
              Kelola dokumen, pantau status persetujuan, dan arsipkan dokumen
            ...
            {dashboardStats?.recentUploads > 0 && (
              <div className="flex items-center gap-2 mt-2">
                ...
                <p className="text-primary text-sm font-medium">
                  {dashboardStats.recentUploads} dokumen diunggah dalam 7 hari
                  terakhir.
                </p>
              </div>
            )}
...
function OverviewTab({
  ...
  return (
    <div className="space-y-6">
        ...
        {statsError ? (
          ...
          <>
            <DashboardCard
              ...
              icon={FileText}
              onClick={() =>
                onOpenList("Semua Dokumen", visibleDocs)
              }
            />
      ...
      <div>
        <ActivityChart
          onDateClick={onChartDateClick}
          onStatusClick={onChartStatusClick}
        />
      </div>
                  ...
                  <span
                    className={`text-[11px] font-semibold px-2.5 py-1 rounded-full shrink-0 ${
                      doc.status === "Diarsipkan"
                        ? "bg-sakura-success/15 text-sakura-success"
                        : doc.status === "Menunggu"
                        ? "bg-sakura-warning/15 text-sakura-warning"
                        : doc.status === "Ditolak"
...
function PersetujuanTab({
  ...
  const fetchPending = useCallback(async () => {
    ...
    try {
      ...
      const sorted = [...raw].sort((a, b) => {
        ...
        if (urgentFlagA !== urgentFlagB) {
          return urgentFlagA ? -1 : 1;
        }

        const hoursA = differenceInHours(
          new Date(),
          new Date(a.requested_at)
        );

        const hoursB = differenceInHours(
          new Date(),
  ...
  const getUrgency = (requestedAt, isUrgentFlag) => {
    ...
    if (hours > 24) {
      return {
        label: "Pending",
        color: "bg-sakura-warning/15 text-sakura-warning",
      };
    }

    return {
      label: "Baru",
      color: "bg-sakura-success/15 text-sakura-success",
    };
  };
  ...
  const handleApprove = async (req) => {
    try {
      ...
      setSuccessMsg(
        `Dokumen "${req.judul}" berhasil disetujui dan diarsipkan.`
      );
  ...
  if (requests.length === 0) {
    return (
      <div className="bg-card rounded-2xl border border-border p-12 text-center">
        <CheckCircle
          size={48}
          className="mx-auto text-sakura-success mb-3"
        />
  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        {requests.map((req) => {
          ...
          return (
            <div
              key={req.id}
              className={`bg-card rounded-2xl border overflow-hidden hover:shadow-card-hover ${
            ...
            >
              ...
              <div className="p-5 space-y-3">
                <h4 className="font-bold text-foreground text-[13px] line-clamp-2">
                  {req.judul}
                </h4>
      ...
      {approveId && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-foreground/40 glass"
          onClick={() => setApproveId(null)}
        >
          <div
            className="bg-card rounded-2xl shadow-elevated w-full max-w-md p-6"
          ...
          >
            ...
            <div className="flex gap-2 justify-end">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg bg-sakura-success text-white text-sm font-bold hover:opacity-90"
              >
                Setujui
              </button>
            </div>
          ...
          >
            ...
            <div className="flex gap-2 justify-end">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg bg-destructive text-destructive-foreground text-sm font-bold hover:opacity-90"
              >
                Tolak
              </button>
            </div>
